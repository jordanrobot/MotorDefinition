...
## JordanRobot\.MotorDefinition\.Model Namespace

| Classes | |
| :--- | :--- |
| [Curve](JordanRobot.MotorDefinition.Model.Curve.md 'JordanRobot\.MotorDefinition\.Model\.Curve') | Represents a named motor torque/speed curve\. |
| [DataPoint](JordanRobot.MotorDefinition.Model.DataPoint.md 'JordanRobot\.MotorDefinition\.Model\.DataPoint') | Represents a single point on a motor torque curve\. |
| [Drive](JordanRobot.MotorDefinition.Model.Drive.md 'JordanRobot\.MotorDefinition\.Model\.Drive') | Represents a drive configuration for a motor\. |
